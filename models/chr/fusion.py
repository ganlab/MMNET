...
class ChrFusion(nn.Module):
    def __init__(self, genetic_relatedness_size, p_snp_upper, p_snp_lower, p_genetic_relatedness, p_fusion, windows, count, stride=3):
        super(ChrFusion, self).__init__()
        self.ve_upper = VEUpperBranch(p_snp_upper, stride=stride)
        self.ve_lower = VELowerBranch(p_snp_lower, windows, count)
